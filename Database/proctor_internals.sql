...
CREATE TABLE `internals` (
  `SEM_No` int NOT NULL,
  `SUB_1` varchar(25) DEFAULT NULL,
  `SUB_2` varchar(25) DEFAULT NULL,
  `SUB_3` varchar(25) DEFAULT NULL,
  `SUB_4` varchar(25) DEFAULT NULL,
  `SUB_5` varchar(25) DEFAULT NULL,
  `SUB_6` varchar(25) DEFAULT NULL
